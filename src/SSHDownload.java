...
public class SSHDownload 
{
	...
	public void run()
	{
	    ...
	    srcDirectory="/ES/logs/";
	    StringBuffer results = new StringBuffer();
	   
//	    destDirectory = "/usr/local/lib/mecab/dic/mecab-ko-dic/";
	    
//	    destDirectory = "/TOM/ECM_Delegate/lib/";
//	    destDirectory = "/TOM/Documentum/Shared/dfc/";
	    
	    destDirectory = "D:\\Upload\\";
...
//						 SSHClient.GET(srcDirectory, destDirectory, list[i].getName(),serverlists[0]+ "_" + list[i].getName());
					 }
